...
- [RESULT-0038](EVIDENCE_LEDGER.md#result-0038--greed-behavior-clears-four-checks-but-exact-coverage-misses-one-hard-cell) replaced elapsed-time classification with a deterministic 500,000-path-state cap and closed reproducibly on 128 fresh games. Greed ratio cleared controlled response, win tracking, score non-redundancy, and seed-stability checks: policy means rose 0.386→0.950, win/greed correlation was 0.953, score/greed correlation was 0.617, and minimum greed-bin stability was 100%. The primary result is still `INCONCLUSIVE` because percentile 0.75 × Level 10 had 0/8 exact-complete games, missing the frozen every-cell coverage rule. Keep greed ratio as a strong candidate, not an adopted axis. Do not add seeds or raise this run's cap. Half-score move remains diagnostic and still needs an independently manipulated timing experiment or replacement. [RESULT-0037](EVIDENCE_LEDGER.md#result-0037--deterministic-greed-corpus-is-preserved-but-its-frozen-closeout-command-is-unusable) and [RESULT-0036](EVIDENCE_LEDGER.md#result-0036--exact-greed-confirmation-is-not-entitled-because-timeout-sensitive-closure-did-not-reproduce) remain preserved `UNVERIFIED` predecessors and back no domain outcome.
