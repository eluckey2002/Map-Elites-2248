...
- [RESULT-0047](EVIDENCE_LEDGER.md#result-0047--five-retained-board-elites-replay-and-receive-distinct-owner-judgments) adds five exact owner playtests to the closed board map without changing RESULT-0046's registered conclusion. The owner beat the current reference bot on all five fixed sessions. Three cell-0,5 elites finished in 11, 10, and 8 moves and were described respectively as good tactical containment, quick and easy, and quick and balanced; the cell-6,1 board was a repetitive low-pressure grind. Read the [playtest report](experiments/RESULT-0046/playtest-report.md) and reproduce it with `node experiments/RESULT-0046/replay-playtests.js`. These are fixed-session results and owner judgments, not a general fun or difficulty model.
