...
const RESULT = 'RESULT-0033';
const CONFIRMATION_SEEDS = Object.freeze(Array.from({ length: 8 }, (_, index) => 32600000 + index));
...
const SOURCE_PATHS = Object.freeze([
  'experiments/RESULT-0033/subject.js',
  'experiments/RESULT-0033/run.js',
  'experiments/RESULT-0033/verify.js',
  'experiments/RESULT-0033/run.test.js',
  'experiments/RESULT-0033/verify.test.js',
...
module.exports = {
  CONFIRMATION_SEEDS, DEEP_SEARCH, PROFILE_LEVELS, RESULT, ROOT, SHALLOW_SEARCH,
  SOURCE_PATHS, artifactWithIdentity, canonicalJson, identity, profiles, sourceHashes,
};
