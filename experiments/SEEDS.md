...
| 41,000,000–41,000,001 | RESULT-0040 fresh-board owner-versus-oracle challenge: Level 56 uses 41,000,000; Level 58 uses 41,000,001 | 2026-09-16 | `experiments/RESULT-0040/registered-protocol.md` |
| 41,500,000 | exploratory board MAP-Elites end-to-end smoke run; excluded from confirmation | 2026-09-17 | `solver/board-map-elites.js` development calibration |
| generator `20,260,918`; gameplay `42,000,000–42,000,002` | RESULT-0045 invalid board MAP-Elites confirmation; all generated rows retained but no domain outcome | 2026-09-17 | `experiments/RESULT-0045/registered-protocol.md`, `closure.json` |
| generator `20,260,919`; gameplay `43,000,000–43,000,002` | RESULT-0046 board MAP-Elites successor confirmation, reserved before execution | 2026-09-17 | `experiments/RESULT-0046/protocol.md` |
