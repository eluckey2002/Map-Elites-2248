...
result: RESULT-0030
status: complete
registered: 2026-09-08T09:15:55Z
supersedes: RESULT-0029
reportable: confirmation
version_freeze:
  experiments/RESULT-0030/run.js: c85a026ec77bace7
  experiments/RESULT-0030/verify.js: 651100d9ae2d118d
  experiments/RESULT-0030/analyze.js: 680498d5ea5ff4f5
  solver/tests/syntheticDescriptorValidation.test.js: 6e6f185b27780a82
...
**Registered:** 2026-09-08, before any RESULT-0030 control or confirmation
game was played.
**Code result:** `6c61d96825939dca99e9da8cfc97d1f60c941758`.

This protocol supersedes RESULT-0029, whose malformed registered hash stopped
the runner before compute and produced no games. This file is the sole
scientific authority for RESULT-0030. Orchestration records may point here but
...
before RESULT-0030 outcomes by a purposive, deterministic coverage rule: span
...
- Control: `34000000..34000003`, four seeds, never reportable.
- Confirmation: `35000000..35000011`, twelve seeds, reportable once.
...
The 34M and 35M ranges were absent from `experiments/SEEDS.md`, the worktree,
...
- Focused code suite: 45/45 PASS.
- Repository suite: 375 tests / 371 pass / 4 fail. The failures are the two
...
- No RESULT-0030 protocol, seed reservation, control artifact, confirmation
...
1. Run `node tools/new-experiment.js --check RESULT-0030`; stop before commit
   if it fails.
2. Commit this protocol, calculator, calculator tests, and seed reservations
   before any RESULT-0030 game.
