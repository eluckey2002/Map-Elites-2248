...
const RESULT = 'RESULT-0037';
const PROFILE_LEVELS = Object.freeze([10, 31, 53, 54]);
const PERCENTILES = Object.freeze([0.25, 0.5, 0.75, 1]);
const CONFIRMATION_SEEDS = Object.freeze(Array.from({ length: 8 }, (_, index) => 33400000 + index));
const EXACT_MAX_PATH_STATES = 500000;
const EMERGENCY_TIMEOUT_MS = 30000;
const EXPECTED_GAMES = PROFILE_LEVELS.length * PERCENTILES.length * CONFIRMATION_SEEDS.length;
const SOURCE_PATHS = Object.freeze([
  'experiments/RESULT-0037/registered-protocol.md',
  'experiments/RESULT-0037/closeout-contract.json',
  'experiments/RESULT-0037/subject.js',
  'experiments/RESULT-0037/result.js',
  'experiments/RESULT-0037/run.js',
  'experiments/RESULT-0037/recompute.js',
  'experiments/RESULT-0037/verify.js',
  'experiments/RESULT-0037/result.test.js',
  'experiments/RESULT-0037/run.test.js',
  'experiments/RESULT-0037/verify.test.js',
