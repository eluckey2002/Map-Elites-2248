...
It supersedes RESULT-0039, whose first qualification attempt stopped before
confirmation because its frozen verifier omitted the seed-constant import.
...
33,700,000–33,700,007: 128 ordered games, percentile then level then seed.
...
`experiments/RESULT-0040/verify.js#verifyArtifact`.
