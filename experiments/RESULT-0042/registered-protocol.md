# Frozen protocol — real-board greed-ratio validation with a calibrated watchdog
...
This run supersedes RESULT-0041, whose qualified confirmation became invalid
when its 30-second emergency watchdog fired after 96 of 128 games. A replay of
that already-burned failure position completed in 14.584 seconds with the same
500,000-state deterministic cap. This successor changes only the infrastructure
watchdog to 120 seconds and uses a fresh confirmation seed range.
...
33,900,000–33,900,007: 128 ordered games, percentile then level then seed.
...
`experiments/RESULT-0042/verify.js#verifyArtifact`.
