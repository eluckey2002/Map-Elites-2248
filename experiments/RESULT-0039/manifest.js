...
const QUALIFICATION_TESTS = Object.freeze([
  'experiments/RESULT-0039/result.test.js',
  'experiments/RESULT-0039/run.test.js',
  'experiments/RESULT-0039/verify.test.js',
...
const SOURCE_ENTRY_PATHS = Object.freeze([
  'experiments/RESULT-0039/manifest.js',
  'experiments/RESULT-0039/subject.js',
  'experiments/RESULT-0039/result.js',
  'experiments/RESULT-0039/recompute.js',
  'experiments/RESULT-0039/run.js',
  'experiments/RESULT-0039/verify.js',
  'experiments/RESULT-0039/qualify.js',
  'solver/exact-greed-worker.js',
  ...QUALIFICATION_TESTS,
]);
const SOURCE_DOCS = Object.freeze([
  'experiments/RESULT-0039/registered-protocol.md',
  'experiments/RESULT-0039/closeout-contract.json',
]);
