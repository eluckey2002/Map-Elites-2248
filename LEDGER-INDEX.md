...
**narrowed** · `direct_source` · corrected by [CORRECTION-0008]
...
**narrowed** · `replayed_lower_bound` · corrected by [CORRECTION-0010]
...
**narrowed** · `UNKNOWN` · corrected by [CORRECTION-0010]
...
**accepted** · `heuristic_observation`
...
**accepted** · `owner_decision` for shipping itself
...
**narrowed** · `heuristic_observation` · corrected by [CORRECTION-0003]
...
**accepted** · `owner_decision` for shipping and for holding the target
...
**accepted** · `heuristic_observation` for the bounded archive and policy results
...
**accepted** · `heuristic_observation` for generalization over the fixed unseen sample
...
**accepted** · `heuristic_observation` for generalization from the fixed seed samples and reference policy
...
**accepted** · `heuristic_observation` for the empirical response over these fixed policies, layouts, and seeds
...
**accepted** · `exact_result` for replay on the identified subject
...
**accepted** · `heuristic_observation` for the paired policy comparison over the fixed levels and fresh seeds
...
**accepted** · `exact_result` for the identified deterministic authoring outputs, complete fixed-seed replay, dependency identities, and historical recording replays
...
**accepted** · `replayed_upper_bound` for every successful witness's moves and tested cap
...
**accepted** · `exact_result` for each identified opening board's viable-start fraction
...
**accepted** · `replayed_lower_bound` for every successful witness and its constructed lineage
...
**accepted** · `direct_source` for deterministic identities, counts, and verification
...
**accepted** · `replayed_lower_bound` for each successful witness and its tracked lineage
...
**provisional** · `direct_source` for the two retained timeout/completeness counts, identity checks, closure mismatch, and honest receipt
...
**narrowed** · `direct_source` for qualification controls, identities, the terminal watchdog condition, closure status, and absence of retained outcome rows · corrected by [CORRECTION-0011, RESULT-0042]
...
**accepted** · `direct_source` for frozen identities, row counts, exact/work-limit standings, artifact verification, qualified closeout path, and executable closure
...
**accepted** · `direct_source` for frozen identities, counts, pairing, artifact verification, and executable closure
...
**narrowed** · `owner_decision` · corrected by [CORRECTION-0012]
...
**accepted** · `owner_decision`, authorized by the accepted persistent goal's predeclared promote/revise/reject outcome and the committed RESULT-0029 disposition rule
...
**accepted** · `direct_source` for the chain counts and the generator's structure
...
**accepted** · `direct_source` for the identity invalidation
...
**accepted** · `direct_source` for the implementation/protocol mismatch and recorded counts
...
**accepted** · `direct_source` for the vacuous middle-bin calculation, verifier acceptance surface, omitted dependencies, retained rows, and unchanged primary disposition
...
**accepted** · `direct_source` for chain legality, the constructed recovery example, and what the occupancy function counts
...
**accepted** · `exact_result` for the 25 recorded sessions under their bound boards, seeds, recordings, and current bot
...
**accepted** · `direct_source` for the deletion, the unchanged inputs, and the verifier verdicts
...
**accepted** · `direct_source` for the vendored identity and the verifier verdict
...
**accepted** · `direct_source` for reachability and the preserved identity
