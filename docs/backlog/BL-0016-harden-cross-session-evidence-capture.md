...
- 2026-09-26: CORRECTION-0014: RESULT-0017/0021/0024/0025/0026 pass at their admission commits (checked by a diagnosis agent; RESULT-0017 re-run by the owner session: 20 cells, 3 replays, champion hashes PASS). Their reverify now runs in a detached worktree at that commit; three need a real checkout, not git archive. 10 flagged records remain.
- 2026-09-26: F7 follow-up closed. Both uncited numbers came from RESULT-0008 (2026-08-12) and were stale; today's `solver/verify-loop.js` at `217f945` prints 97-100% wins and 0% lockouts on sampled levels. Added RESULT-0051 (direct_source), marked RESULT-0008 stale, and AGENTS.md/CURRENT.md now cite RESULT-0051.
