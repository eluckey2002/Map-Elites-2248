...
Canonical result: `.orch/tickets/2026-09-01-premise-discovery-readiness/PD-004R.md`, terminal SHA-256 `4d34aac3bfe8fdf2c417e80e86f6d0bcb8712861d2bc18d9dd8641aad4004298`. Final integration: `PD-004V4.md`, terminal SHA-256 `95e2837e796a015d6ef45ba1156911646ace0f1ba67f4042a0e62122a2745b51`, five of five criteria `PASS`, weakest oracle class `judged`. Original `PD-001` through `PD-004` and rejected/invalidated verifiers remain retained failure records; the accepted evidence lineage is `PD-001R` through `PD-004R`, the unchanged independent judged entries in terminal `PD-004V2`, and the clean-worktree deterministic join in `PD-004V4`.

Cost exception: the original four-unit topology was not met. All three first-pass agents failed to persist to the canonical ticket location, requiring three separately bounded persistence-first recovery tickets. The synthesis then required its checker, an initial verifier invalidated by terminal status sequencing, a verifier that correctly failed after the management worktree moved, and rejection of a child-owned terminal transition before the final caller-run join. Broad discovery, gameplay, measurements, and broad suites were not repeated, but this campaign is evidence-valid rather than a clean demonstration of the intended cost envelope.
