...
As of 2026-09-03, level authoring uses the frozen `calib-1` evaluator rather than the mutable live bot (`RESULT-0027`). The active gen-0014 authoring candidate reproducibly measures to a 102,000 target, while the shipped 101,000 Level 53 board remains unchanged and replayable from the candidate archive. This freezes the measuring instrument; it does not ship the new candidate or establish human difficulty.
...
- **proof_class:** `exact_result` for the identified deterministic authoring outputs, complete fixed-seed replay, dependency identities, and historical recording replays; `heuristic_observation` for the fitting and holdout score outcomes over their fixed samples. No policy-independent score bound or human-performance conclusion follows.
- **as_of:** 2026-09-03
